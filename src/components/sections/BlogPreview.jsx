      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
        {loading ? (
          ...
          blogs.map((post, index) => (
            ...
            >
              <div className="bg-white rounded-[2.5rem] overflow-hidden border border-slate-100 shadow-sm hover:shadow-2xl hover:shadow-indigo-500/10 transition-all duration-500 flex flex-col h-full">
