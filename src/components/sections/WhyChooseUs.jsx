              ...
              <div className="relative z-10 space-y-10">
                ...
                <div className="space-y-6">
                  {[
                    ...
                    >
                      ...
                      <span className="font-bold text-lg text-indigo-50">{item}</span>
                    </motion.div>
                  ))}
                </div>
                ...
                <div className="pt-6">
                  ...
                  >
                    ...
                    <div>
                      <p className="text-slate-900 text-xl font-bold">Registration Open</p>
                      <p className="text-indigo-600 text-sm font-bold">Apply for Batch 2026 Today</p>
                    </div>
                  </motion.div>
                </div>
              </div>
