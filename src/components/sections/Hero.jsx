                ...
                <div className="relative h-full flex items-center justify-center text-center px-4 sm:px-6 lg:px-8 pt-28 sm:pt-32 pb-12">
                  <div className="max-w-5xl">
                    ...
                    >
                      ...
                      <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-black text-white tracking-tight mb-4 sm:mb-6 leading-[1.1] drop-shadow-2xl px-2">
                        {slide.title} <br />
                      ...
                      <p className="max-w-3xl mx-auto text-sm sm:text-base md:text-lg text-slate-200 leading-relaxed mb-8 sm:mb-10 font-medium drop-shadow-md px-4">
                        {slide.desc}
                      </p>
                      ...
                      <div className="flex flex-col sm:flex-row items-center justify-center gap-4 sm:gap-6">
                        <motion.button
                          ...
                          className="w-full sm:w-auto px-6 py-3 sm:px-8 sm:py-3.5 bg-indigo-600 text-white rounded-xl sm:rounded-2xl font-bold text-sm sm:text-base hover:bg-indigo-700 transition-all duration-300 shadow-2xl shadow-indigo-600/40 flex items-center justify-center gap-2"
                        >
                        ...
                        >
                          <Link
                            to="/programs"
                            className="w-full sm:w-auto px-6 py-3 sm:px-8 sm:py-3.5 bg-white/10 backdrop-blur-md text-white border border-white/20 rounded-xl sm:rounded-2xl font-bold text-sm sm:text-base hover:bg-white/20 transition-all duration-300 flex items-center justify-center"
                          >
                            Browse Programs
                          </Link>
                        </motion.div>
