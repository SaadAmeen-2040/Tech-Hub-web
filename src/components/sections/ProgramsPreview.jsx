      ...
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col md:flex-row justify-between items-end mb-16 gap-6">
          ...
          >
            <Link 
              to="/programs" 
              className="group px-6 py-3 sm:px-8 sm:py-3.5 bg-slate-900 text-white rounded-2xl font-bold text-sm sm:text-base hover:bg-indigo-600 transition-all duration-300 shadow-xl shadow-slate-900/10 flex items-center gap-2"
            >
              View All Tracks
        ...
        >
          {previewPrograms.map((program) => (
            <motion.div 
              ...
              className="group bg-white rounded-[2rem] p-6 sm:p-8 border border-slate-100 shadow-sm hover:shadow-2xl hover:shadow-indigo-500/10 transition-all duration-500 flex flex-col justify-between"
            >
              <div>
                <div className="flex items-center justify-between mb-8">
                  <motion.div 
                    whileHover={{ scale: 1.05 }}
                    className="w-12 h-12 sm:w-14 sm:h-14 bg-slate-50 rounded-2xl flex items-center justify-center group-hover:bg-indigo-600 group-hover:text-white transition-colors duration-500 shrink-0"
                  >
                ...
                <h3 className="text-xl sm:text-2xl font-bold text-slate-900 mb-4 group-hover:text-indigo-600 transition-colors">
                  {program.title}
                </h3>
                
                <p className="text-sm sm:text-base text-slate-500 mb-8 line-clamp-2 leading-relaxed">
                  {program.description}
                </p>
              </div>
              ...
              <motion.button 
                ...
                className="w-full py-3 sm:py-3.5 bg-slate-50 text-slate-900 rounded-xl font-bold text-sm sm:text-base group-hover:bg-indigo-600 group-hover:text-white transition-all duration-300 flex items-center justify-center gap-2"
              >
